...
folder_path = 'C:/Users/DELL/Documents/LIRNEasia/ADB/'
...
def main(data_path, tags_path, ocr_output_path, embedding_model):
    sample = read_sample_data(data_path, tags_path)
    sample = get_ocr_output(ocr_output_path, sample)
